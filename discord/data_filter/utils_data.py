...
from discord.constants import API_LINK, AVATARS_PATH
...
def filter_friend_data(raw_friend, data, header, is_user=False):
    ...
    Args:
        ...
        header (dict): Header of the request (authorization)
    ...
    avatarPath = rf"{AVATARS_PATH}/{id}.png"
    mutual_friends = get_data_from_api(rf"{API_LINK}/users/{id}/relationships", header)
